...
screen_dimensions = pygame.display.get_desktop_sizes()[0]

constants['SCREEN_WIDTH'] = screen_dimensions[0]
constants['SCREEN_HEIGHT'] = screen_dimensions[1]
constants['HUD_DIVIDE'] = constants['SCREEN_HEIGHT'] / 7.2
constants['PLAYABLE_HEIGHT'] = constants['SCREEN_HEIGHT'] - constants['HUD_DIVIDE']
